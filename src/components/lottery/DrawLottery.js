...
import { drawLottery } from '../../services/lotteryService';
...
const DrawLottery = ({ lottery, onClose, onDrawComplete }) => {
  ...
  const startPrizeDraw = (prizeIndex) => {
  ...
  }, [showCountdown, countdownValue, lottery]);
  ...
  }, [animationPhase, finalReveal, selectedTickets]);
